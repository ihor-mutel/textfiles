...
! function(a) {
    ...
    return function b(a, c, d) {
        ...
        19: [function(a, b, c) {
            ...
            var s = function(a) {
                ...
                return h(b, a), b.prototype.createEl = function() {
                    ...
                    a.prototype.handleMouseDown.call(this, b), this.player_.scrubbing(!0), this.videoWasPlaying = !this.player_.paused(), this.pauseTimer_ = this.setTimeout(function() {
                        this.player_.pause()
                    }, 100)
                }, b.prototype.handleMouseMove = function(a) {
                    var b = this.calculateDistance(a) * this.player_.duration();
                    b === this.player_.duration() && (b -= .1), this.player_.currentTime(b), "mousemove" === a.type && (this.clearTimeout(this.pauseTimer_), this.player_.pause())
                }, b.prototype.handleMouseUp = function(b) {
                    a.prototype.handleMouseUp.call(this, b), this.clearTimeout(this.pauseTimer_), this.player_.scrubbing(!1), this.videoWasPlaying && this.player_.play()
                ...
                q = function(a) {
                    ...
                    return h(b, a), b.prototype.createEl = function() {
                        ...
                        var b = this.contentEl(),
                            c = b.parentNode,
                            d = b.nextSibling;
                        return this.trigger("beforemodalfill"), this.hasBeenFilled_ = !0, c.removeChild(b), this.empty(), j.insertContent(b, a), this.trigger("modalfill"),
                            d ? c.insertBefore(b, d) : c.appendChild(b), this
            ...
            var Z = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "volumechange", "texttrackchange"],
                $ = function(a) {
                    ...
                    return h(b, a), b.prototype.dispose = function() {
                        ...
                        var b = this.tag,
                            c = void 0,
                            d = this.playerElIngest_ = b.parentNode && b.parentNode.hasAttribute("data-vjs-player");
            ...
            var j = a(5),
                ...
                L = function(a) {
                    function b() {
                        ...
                        }), c.nativeCaptions === !1 && (e.featuresNativeTextTracks = !1), e.featuresNativeTextTracks || e.emulateTextTracks(), e.autoRemoteTextTracks_ = new u["default"], e.initTextTrackListeners(), e.initTrackListeners(), c.nativeControlsForTouch || e.emitTapEvents(), e
                    }
                    ...
                    function b() {
                        ...
                        return "disabled" !== i && n.tech_.on("timeupdate", s), Object.defineProperty(n, "default", {
                            ...
                            get: function() {
                                ...
                                return this.activeCues_ = b, q.setCues_(this.activeCues_),
                                    q
                            },
                            set: function() {}
        ...
        93: [function(b, c, d) {
            ...
            n.autoSetupTimeout(1, g), g.VERSION = "5.15.1", g.options = x["default"].prototype.options_, g.getPlayers = function() {
        ...
        99: [function(a, b, c) {
            ...
            function h(a) {
                ...
                var n, o, p, q = l.url = a.uri || a.url,
                    ...
                    u = !!a.sync,
                    v = !1;
                if ("json" in a && (v = !0, t.accept || t.Accept || (t.Accept = "application/json"), "GET" !== r && "HEAD" !== r && (t["content-type"] || t["Content-Type"] || (t["Content-Type"] = "application/json"),
                        s = JSON.stringify(a.json))), l.onreadystatechange = b, l.onload = f, l.onerror = d, l.onprogress = function() {}, l.ontimeout = d, l.open(r, q, !u, a.username, a.password), u || (l.withCredentials = !!a.withCredentials), !u && a.timeout > 0 && (p = setTimeout(function() {
                        o = !0, l.abort("timeout");
                        var a = new Error("XMLHttpRequest timeout");
                        a.code = "ETIMEDOUT", d(a)
                    }, a.timeout)), l.setRequestHeader)
                    for (n in t) t.hasOwnProperty(n) && l.setRequestHeader(n, t[n]);
